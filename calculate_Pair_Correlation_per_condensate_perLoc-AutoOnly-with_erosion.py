...
"""
The program calculates per-location Pair Correlation Function (PCF; aka. Radial Distribution Function, RDF) of single channel single partical tracking (SPT) data.
...
It saves four PCF with corresponding informatioon in a single pickle file: auto PCF of channel 1
"""
...
def process_file(
    ...
    # edges = (img_PAINT > 5) & (img_PAINT_right > 5)
    ...
    auto = PairCorr_with_edge_correction(
        df,
        mask,
        nm_per_pxl,
        r_max_nm,
...
def main():
    ...
    folder_save = "../"
    fname_save = "PairCorr-erode7-DataDict-pooled-perLoc.p"
