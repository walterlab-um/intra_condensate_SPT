...
plt.title("Aging, no Dextran", fontsize=15)
plt.xlim(log10D.min(), log10D.max())
plt.ylim(plt_ylim[0], plt_ylim[1])
plt.xlabel(r"Apparent log$_{10}$D, $\mu$m$^2$/s", fontsize=15)
...
plt.ylim(0, 1)
plt.title("Aging, without Dextran", fontsize=15)
plt.ylabel("Static Fraction", fontsize=15)
plt.gca().spines[:].set_linewidth(3)
plt.gca().tick_params(axis="both", which="major", labelsize=15)
# plt.tight_layout()
plt.savefig(
...
for fname_data in lst_fname[5:-1]:
    ...
    i += 1
sns.move_legend(ax, 0, title=None, frameon=False)
plt.title("Aging, 10% Dextran", fontsize=15)
plt.xlim(log10D.min(), log10D.max())
plt.ylim(plt_ylim[0], plt_ylim[1])
plt.xlabel(r"Apparent log$_{10}$D, $\mu$m$^2$/s", fontsize=15)
plt.ylabel("SA Occupation", fontsize=15)
...
for fname_data in lst_fname_RNA:
    ...
    i += 1
sns.move_legend(ax, 0, title=None, frameon=False)
plt.title("Effect of RNA, no Dextran", fontsize=15)
plt.xlim(log10D.min(), log10D.max())
plt.ylim(plt_ylim[0], plt_ylim[1])
plt.xlabel(r"Apparent log$_{10}$D, $\mu$m$^2$/s", fontsize=15)
plt.ylabel("SA Occupation", fontsize=15)
...
for fname_data in lst_fname_RNA:
    ...
    i += 1
sns.move_legend(ax, 0, title=None, frameon=False)
plt.title("Effect of RNA, 10% Dextran", fontsize=15)
plt.xlim(log10D.min(), log10D.max())
plt.ylim(plt_ylim[0], plt_ylim[1])
plt.xlabel(r"Apparent log$_{10}$D, $\mu$m$^2$/s", fontsize=15)
plt.ylabel("SA Occupation", fontsize=15)
